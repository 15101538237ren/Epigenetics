...
Hello, this repo aims to summarize all the current knowledge we know about Epigenetics and Gene Regulation, also any topics of Epigenetics in contexts of development, aging and cancer. If you are interested to contribute, please contact hongleir@uci.edu, we are looking forard your expertise. 
...
2. CpG island proofreading may therefore participate as a general or redundant support during normal development, limiting phenotypes to specific, although essential, developmental transitions (from [1]). 
...
1. TET1 mostly binds CpG island promoters, including at housekeeping and developmental genes, and probably functions at many enhancers as well [24, 26]. 

2. TET1 recruitment is not altered when DNA methylation, and hence hmC, is completely erased, suggesting that TET1 may bind in larger complexes to function as a general epigenetic proofreader[24, 25]. 
